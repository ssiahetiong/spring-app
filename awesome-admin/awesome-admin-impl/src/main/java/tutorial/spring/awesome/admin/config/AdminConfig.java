...
@Configuration
@EnableJpaRepositories("tutorial.spring.awesome.admin.repo")
@ComponentScan("tutorial.spring.awesome.admin")
public class AdminConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("tutorial.spring.awesome.admin.entity");
